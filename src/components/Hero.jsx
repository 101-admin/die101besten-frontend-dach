...
const Hero = () => {
  return (
    <section
      ...
      className="w-full h-screen bg-cover bg-no-repeat pt-36  mb-7"
    >
      <div className="container">
        <div className="px-5 py-4 md:pl-10 md:py-7 lg:pl-14 lg:py-10 bg-gradient-to-r from-[#FFFFFF] to-[#FFFFFF00] sm:w-[70%] xl:w-1/2">
          <h1 className="text-[30px] leading-[30px] font-normal font-ogg sm:text-[38px] sm:leading-[38px] md:text-[45px] md:leading-[45px] lg:text-[51px] lg:leading-[51px] xl:text-[64px] xl:leading-[57px] mb-5 md:mb-10">
            Etiam sit <span className="text-[#B65033]">amet Orci Eget</span>{" "}
