...
const Page = ({params}: {params: any}) => {
  ...
  useEffect(() => {
    const fetchData = async()=>{
      await fetch(
        `https://app.cockpit.legal/api/cockpit/resources/legaldocumentshare/339d190143d759306016a534dc8e56de/document/render/html?language=${locale}`
      )
    ...
    <>
      <section className="max-w-[800px] mx-auto w-full   grid grid-cols-1 gap-6 p-12">
        ...
        <noscript>
          ...
          <Link
            target="_blank"
            href={`https://app.cockpit.legal/api/cockpit/resources/legaldocumentshare/339d190143d759306016a534dc8e56de/document/render/html?language=${locale}`}
