...
const PageContent = ({locale}: {locale: string}) => {
  ...
  useEffect(() => {
    const fetchData = async()=>{
      await fetch(
        `https://app.cockpit.legal/api/cockpit/resources/legaldocumentshare/222c88507bce88f742614e789df06254/document/render/html?language=${locale}`
      )
    ...
    <>
      <section className="max-w-[800px] mx-auto w-full  grid grid-cols-1 gap-6 p-12">
        ...
        <noscript>
          ...
          <Link
            target="_blank"
            href={`https://app.cockpit.legal/api/cockpit/resources/legaldocumentshare/222c88507bce88f742614e789df06254/document/render/html?language=${locale}`}
